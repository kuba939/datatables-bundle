...
class DataTablesTest extends AbstractTest
{
    ...
    public function testRenderTable()
    {
        ...
        $result = $this->service->renderTable($this->environment);
    ...
    public function testRenderJs()
    {
        ...
        $result = $this->service->renderJs($this->environment);
    ...
    {
        $result = $this->service->convertFunctions($this->environment, $sourceJson);
    ...
    public function testAddDataTable()
    {
        ...
        $this->service->addDataTable($this->environment, $columns, $params);
    ...
    public function testAddDataTableJs()
    {
        ...
        $this->service->addDataTableJs($this->environment, $columns, $params);
        $resultParams = $this->getProtectedValue($this->service, 'params');
    ...
    public function testAddDataTableHtml()
    {
        ...
        $this->service->addDataTableHtml($this->environment, $columns, $params);
        $resultParams = $this->getProtectedValue($this->service, 'params');
    ...
    {
        $this->service->addDataTable($this->environment, $this->dataTable);
